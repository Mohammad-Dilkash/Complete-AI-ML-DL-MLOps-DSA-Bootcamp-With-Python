...
# installed.
TCL_PREFIX='I:/Complete-AI-ML-DL-MLOps-DSA-Bootcamp-With-Python/Complete Python With DSA Bootcamp + LEETCODE Exercises/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='I:/Complete-AI-ML-DL-MLOps-DSA-Bootcamp-With-Python/Complete Python With DSA Bootcamp + LEETCODE Exercises/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='I:/Complete-AI-ML-DL-MLOps-DSA-Bootcamp-With-Python/Complete Python With DSA Bootcamp + LEETCODE Exercises/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-II:/Complete-AI-ML-DL-MLOps-DSA-Bootcamp-With-Python/Complete Python With DSA Bootcamp + LEETCODE Exercises/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LI:/Complete-AI-ML-DL-MLOps-DSA-Bootcamp-With-Python/Complete Python With DSA Bootcamp + LEETCODE Exercises/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='I:/Complete-AI-ML-DL-MLOps-DSA-Bootcamp-With-Python/Complete Python With DSA Bootcamp + LEETCODE Exercises/venv\Library\lib\tclstub86.lib'
